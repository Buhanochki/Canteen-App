<h1 align="center">Столовая и точка</h1>

Столовая и точка — веб-приложение, разработанное на языке Python, с использованием фреймворков Django и Bootstrap и системой управления базами данных SQLite3. Веб-приложение станет надежным инструментом для управления школьными столовыми, что в свою очередь повысит эффективность работы учебных заведений.

<h2>Видеоролик</h2>

https://vkvideo.ru/video-236044924_456239017?list=ln-pXsRMyAzp1RHdnUYVp
...
1. Скачайте проект:
   ...
   Скачайте или клонируйте репозиторий с проектом на ваш компьютер:
    ...
    ```git clone https://github.com/Buhanochki/Canteen-App/```
